  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="simpleSiteApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="simpleSiteApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('simpleSiteApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('simpleSiteApp.location.postalCode')}
                id="location-postalCode"
                name="postalCode"
                data-cy="postalCode"
                type="text"
              />
              <ValidatedField label={translate('simpleSiteApp.location.city')} id="location-city" name="city" data-cy="city" type="text" />
              <ValidatedField
                label={translate('simpleSiteApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('simpleSiteApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
