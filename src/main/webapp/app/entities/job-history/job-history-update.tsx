  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="simpleSiteApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="simpleSiteApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('simpleSiteApp.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('simpleSiteApp.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('simpleSiteApp.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('simpleSiteApp.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField id="job-history-job" name="job" data-cy="job" label={translate('simpleSiteApp.jobHistory.job')} type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('simpleSiteApp.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('simpleSiteApp.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
