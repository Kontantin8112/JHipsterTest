  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="simpleSiteApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="simpleSiteApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('simpleSiteApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('simpleSiteApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('simpleSiteApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('simpleSiteApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('simpleSiteApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('simpleSiteApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('simpleSiteApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('simpleSiteApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('simpleSiteApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
