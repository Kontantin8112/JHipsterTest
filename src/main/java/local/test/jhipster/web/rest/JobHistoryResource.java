...
import local.test.jhipster.domain.JobHistory;
import local.test.jhipster.repository.JobHistoryRepository;
import local.test.jhipster.service.JobHistoryService;
...
/**
 * REST controller for managing {@link local.test.jhipster.domain.JobHistory}.
 */
@RestController
@RequestMapping("/api")
