...
/**
 * REST controller for managing {@link local.test.jhipster.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Employee> partialUpdateEmployee(
        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(existingEmployee -> {
                ...
                if (employee.getIsEngineer() != null) {
                    existingEmployee.setIsEngineer(employee.getIsEngineer());
                }
