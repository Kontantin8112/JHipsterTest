...
import local.test.jhipster.domain.Country;
import local.test.jhipster.repository.CountryRepository;
import local.test.jhipster.service.CountryService;
...
/**
 * REST controller for managing {@link local.test.jhipster.domain.Country}.
 */
@RestController
@RequestMapping("/api")
