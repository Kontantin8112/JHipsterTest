...
import local.test.jhipster.repository.LocationRepository;
import local.test.jhipster.service.LocationService;
...
/**
 * REST controller for managing {@link local.test.jhipster.domain.Location}.
 */
@RestController
@RequestMapping("/api")
