...
import local.test.jhipster.domain.Department;
import local.test.jhipster.repository.DepartmentRepository;
import local.test.jhipster.service.DepartmentService;
...
/**
 * REST controller for managing {@link local.test.jhipster.domain.Department}.
 */
@RestController
@RequestMapping("/api")
