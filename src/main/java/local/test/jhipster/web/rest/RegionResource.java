...
import local.test.jhipster.domain.Region;
import local.test.jhipster.repository.RegionRepository;
import local.test.jhipster.service.RegionService;
...
/**
 * REST controller for managing {@link local.test.jhipster.domain.Region}.
 */
@RestController
@RequestMapping("/api")
