...
import local.test.jhipster.repository.TaskRepository;
import local.test.jhipster.service.TaskService;
...
/**
 * REST controller for managing {@link local.test.jhipster.domain.Task}.
 */
@RestController
@RequestMapping("/api")
