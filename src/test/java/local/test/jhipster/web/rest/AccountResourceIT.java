package local.test.jhipster.web.rest;

import static local.test.jhipster.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import local.test.jhipster.IntegrationTest;
import local.test.jhipster.config.Constants;
import local.test.jhipster.domain.PersistentToken;
import local.test.jhipster.domain.User;
import local.test.jhipster.repository.AuthorityRepository;
import local.test.jhipster.repository.PersistentTokenRepository;
import local.test.jhipster.repository.UserRepository;
import local.test.jhipster.security.AuthoritiesConstants;
import local.test.jhipster.service.UserService;
import local.test.jhipster.service.dto.AdminUserDTO;
import local.test.jhipster.service.dto.PasswordChangeDTO;
import local.test.jhipster.service.dto.UserDTO;
import local.test.jhipster.web.rest.vm.KeyAndPasswordVM;
import local.test.jhipster.web.rest.vm.ManagedUserVM;
