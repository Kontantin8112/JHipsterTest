package local.test.jhipster.config.timezone;
...
import local.test.jhipster.repository.timezone.DateTimeWrapper;
import local.test.jhipster.repository.timezone.DateTimeWrapperRepository;
