...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2022-05-16T12:56').should('have.value', '2022-05-16T12:56');

      cy.get(`[data-cy="endDate"]`).type('2022-05-16T03:04').should('have.value', '2022-05-16T03:04');
