...
describe('Employee e2e test', () => {
  ...
  describe('Employee page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Employee page', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="lastName"]`).type('Мартынов').should('have.value', 'Мартынов');

      cy.get(`[data-cy="email"]`).type('Brando.43@gmail.com').should('have.value', 'Brando.43@gmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('Большой open').should('have.value', 'Большой open');

      cy.get(`[data-cy="hireDate"]`).type('2022-05-15T14:13').should('have.value', '2022-05-15T14:13');
