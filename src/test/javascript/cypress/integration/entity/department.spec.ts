...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'Loan Калмыкия продукт' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('Bedfordshire координатор').should('have.value', 'Bedfordshire координатор');
